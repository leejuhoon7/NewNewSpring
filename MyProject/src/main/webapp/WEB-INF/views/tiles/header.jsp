...
<div class="container">
    <header class="d-flex justify-content-center py-3">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="${pageContext.request.contextPath}/booklist" class="nav-link">도서목록조회/수정</a></li>
        <li class="nav-item"><a href="${pageContext.request.contextPath}/rentlist" class="nav-link">대여현황조회</a></li>
